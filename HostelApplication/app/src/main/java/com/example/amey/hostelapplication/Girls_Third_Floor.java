...
public class Girls_Third_Floor extends AppCompatActivity {

    TextView t1;
    ListView lv1;
    Button b1;
    private Firebase mref;
    private ArrayList<String> Girls_Third_Floor = new ArrayList<>();
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_girls__third__floor);
        ...
        final ArrayAdapter<String> arrayAdapter=new ArrayAdapter<String>(this,android.R.layout.simple_list_item_1,Girls_Third_Floor);
        ...
        lv1.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int i, long id) {
                ...
                j.putExtra(constient.INTENT_MESSAGE_DATA,Girls_Third_Floor.get(i).toString());
    ...
    {
        Intent i = new  Intent(getApplicationContext(),names_TF.class);
